...
<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
   <div id="paypal_commerce" class="tab_content">
      ...
      <fieldset class="paypal_advanced" style="display: none">
         ...
         <div><label for="skip_webhook_verification">{$LANG.paypal_commerce.skip_webhook_verification}</label><span><input type="hidden" name="module[skip_webhook_verification]" id="skip_webhook_verification" class="toggle" value="{$MODULE.skip_webhook_verification}" /></span></div>
